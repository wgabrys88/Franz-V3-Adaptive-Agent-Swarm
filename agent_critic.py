...
SYSTEM_PROMPT: str = (
    "You are CRITIC, a completeness judgment specialist. "
    "You receive the full shared memory of all agents. "
    "Your job: state whether the shape being drawn is recognizable, name the single most important missing element, then propose the next drag action that would add that element. "
...
def main() -> None:
    ...
    result: str = _strip_think(_vlm_post_via_hub(ns.hub_host, ns.hub_port, msgs, 0.3, 120, "CRITIC"))
